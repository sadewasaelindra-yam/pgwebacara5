...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link mimeType="" description="" type="ArcSDE Connection" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" size="" name="SDE Feature Class" format=""/>
  </links>
  <dates/>
  <fees></fees>
